<x-main-layout title="Onboarding - HopinHome">
    <div class="flex h-screen overflow-hidden bg-white" x-data="{ bio: '', isLoading: false, maxChars: 500 }">
        <!-- Left Side -->
            ...
            <div class="max-w-[560px] w-full mx-auto lg:mx-0">
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        class="w-full h-[204px] p-4 border border-[#e8e8e7] rounded-lg focus:border-[#1447d4] focus:ring-0 resize-none transition-all placeholder:text-[#464646] shadow-[0px_2px_6px_0px_rgba(0,0,0,0.06)]"
                    ></textarea>
                </div>
