    ...
    <div class="p-4">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <form x-on:submit.prevent="showDeleteModal = true" method="POST" action="{{ route('property_manager.listings.destroy', $listing->id) }}">
                    @csrf
                    @method('DELETE')
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <form method="POST" action="{{ route('property_manager.listings.destroy', $listing->id) }}">
                                        @csrf
                                        @method('DELETE')                        <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm">
                            Delete
                        </button>
                    </form>
