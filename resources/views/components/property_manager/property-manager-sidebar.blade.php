...
<div class="w-full h-full bg-white flex flex-col">
    ...
    <div class="px-[8px] mb-[16px]">
        ...
        <div>
            ...
            <a href="{{ route('property_manager.index') }}" class="flex items-center space-x-[10px] p-2 rounded-[4px] hover:bg-gray-50 text-[#1e1d1d] transition-colors">
                <img alt="apartment" class="w-[18px] h-[18px]" src="{{ asset('images/apartment_black.svg') }}">
            ...
            <a href="#" class="flex items-center space-x-[10px] p-2 rounded-[4px] hover:bg-gray-50 text-[#1e1d1d] transition-colors">
                <img alt="reviews" class="w-[18px] h-[18px]" src="{{ asset('images/credits_usage.svg') }}">
                <span class="font-medium text-[14px] leading-[1.3]">Credits usage</span>
            </a>
        </div>
    </div>

    {{-- Settings Section --}}
    <div class="px-2 mb-[16px]">
        <p class="text-[12px] font-medium text-[#464646] px-2 mb-[4px] leading-[1.5]">Settings</p>
        <div class="space-y-1">
    ...
    {{-- Support Section --}}
    <div class="px-2 mb-[16px]">
        <p class="text-[12px] font-medium text-[#464646] px-2 mb-[4px] leading-[1.5]">Support</p>
        <div class="space-y-1">
            <a href="#" class="flex items-center space-x-[10px] p-2 rounded-[4px] hover:bg-gray-50 text-[#1e1d1d] transition-colors">
    ...
    <div class="px-4 mt-auto">
        <a href="{{ route('property_manager.listings.create') }}" class="bg-electric-blue text-white font-medium w-full h-[40px] rounded-[6px] flex items-center justify-center space-x-[6px] hover:opacity-90 transition-all">
