...
<div class="w-full h-full bg-white flex flex-col py-6">
    ...
    <div class="px-2 mb-6">
        ...
        <div class="space-y-1">
            ...
            <a href="{{ route('property_manager.security') }}" class="flex items-center space-x-[10px] p-2 rounded-[4px] {{ request()->routeIs('property_manager.security') ? 'bg-[#f6f6f5] text-[#1e1d1d]' : 'hover:bg-gray-50 text-[#1e1d1d]' }} transition-colors">
