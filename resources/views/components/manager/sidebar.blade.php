<div class="w-full space-y-6">
    ...
    <div class="space-y-2">
        ...
        <a href="{{ route('manager.listings.index') }}" class="flex items-center space-x-3 p-2 rounded-md {{ request()->routeIs('manager.listings.index') ? 'bg-white shadow' : 'hover:bg-white/50' }} transition">
