    ...
    <div @click.away="showModal = false; setTimeout(() => { step = 'email'; email = ''; error = '' }, 300)"
        ...
        <div class="p-8">
            ...
            <div x-show="step === 'email'">
                ...
                <button @click="step = 'password'; error = ''" class="w-full bg-electric-blue text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors mt-6">Continue</button>
            ...
            <div x-show="step === 'password'" style="display: none;">
                <button @click="step = 'email'; error = ''" class="absolute top-4 left-4 text-gray-400 hover:text-gray-600">
