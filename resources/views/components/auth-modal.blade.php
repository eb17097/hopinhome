<div x-data="{ showModal: false, step: 'email' }"
     @open-auth-modal.window="showModal = true"
     @close-auth-modal.window="showModal = false; setTimeout(() => step = 'email', 300)"
     @keydown.escape.window="showModal = false; setTimeout(() => step = 'email', 300)"
     x-show="showModal"
    ...
    <div @click.away="showModal = false; setTimeout(() => step = 'email', 300)"
        ...
        <div class="p-8">
            <button @click="showModal = false; setTimeout(() => step = 'email', 300)" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600">
            ...
            <div x-show="step === 'email'">
                ...
                <button @click="step = 'password'" class="w-full bg-electric-blue text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors mt-6">Continue</button>
            ...
            <div x-show="step === 'password'" style="display: none;">
                ...
                <button class="w-full bg-electric-blue text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors mt-6">Log in</button>
