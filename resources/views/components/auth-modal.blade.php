                ...
                <div class="p-8 pt-6">
                    ...
                    <p class="text-[14px] text-[#464646] text-center mt-6">
                        ...
                        :class="{'text-gray-400 cursor-not-allowed': resendTimer > 0 || isLoading, 'text-[#464646] hover:text-black': resendTimer === 0 && !isLoading}">
                            <span :class="{'opacity-0': isLoading && resendTimer === 0}">Resend <span x-show="resendTimer > 0" x-text="`in 0:${resendTimer < 10 ? '0' : ''}${resendTimer}`"></span></span>
                            <div x-show="isLoading && resendTimer === 0" class="absolute inset-0 flex items-center justify-center">
