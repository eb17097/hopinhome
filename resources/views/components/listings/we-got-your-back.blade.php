<div class="bg-navy-blue rounded-[8px] p-8 text-white relative overflow-hidden flex flex-col justify-between min-h-[263px]">
    ...
    <div class="absolute -bottom-24 -right-16 w-80 h-80 opacity-[0.07] pointer-events-none">
        <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full rotate-[-10deg]">
            ...
            <path d="M10.271 22.2791H6.38379L6.93492 16.8107L6.93497 16.8099L8.49231 1.08723C9.74063 0.559643 11.082 0.209839 12.4849 0.0694805L12.4919 3.8147e-05L10.271 22.2791Z" fill="white"/>
            <path d="M22.7582 16.6149L23.3291 22.2792H24.9745C26.7234 19.9509 27.7599 17.0548 27.7599 13.9158C27.7599 8.978 25.1947 4.64096 21.3276 2.17095L22.7582 16.6149Z" fill="white"/>
            <path d="M17.4889 22.2791H21.3762L20.825 16.8107L20.8249 16.8099L19.2676 1.08723C18.0192 0.559643 16.6779 0.209839 15.275 0.0694805L15.2681 3.8147e-05L17.4889 22.2791Z" fill="white"/>
        </svg>
    </div>
