<div>
    ...
    <div class="space-y-[32px]">
        {{-- Payment option --}}
        <div>
            <label class="block text-[14px] font-medium text-[#1e1d1d] mb-[10px]">Payment option</label>
        ...
        {{-- Utilities --}}
        <div>
            <label class="block text-[14px] font-medium text-[#1e1d1d] mb-[10px]">Utilities</label>
            <div class="flex gap-[11px]">
