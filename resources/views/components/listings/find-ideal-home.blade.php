<div class="bg-gray-50 py-[96px]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-[80px] items-center">
            <div class="relative h-[553px] w-[586px] rounded-2xl overflow-hidden shadow-sm">
                <img src="{{ asset('images/spacejoy-c0JoR_-2x3E-unsplash-1.png') }}"
                     alt="Ideal Home in Dubai"
                     class="w-full h-full object-cover hover:scale-105 transition-transform duration-700">
            </div>

            <div>
                <h2 class="text-3xl font-medium leading-tight tracking-tight text-gray-900 mb-[24px]">
                    Find your <span class="text-blue-600">ideal</span> home
                </h2>

                <div class="space-y-6 text-lg text-gray-500 leading-relaxed w-[538px]">
                    <p>
