                        ...
                        @if($listings->isNotEmpty())
                            <div class="bg-white border border-light-gray rounded-[6px] shadow-[0px_1px_6px_0px_rgba(0,0,0,0.08)] overflow-hidden">
                                ...
                                <div class="p-6 border-t border-light-gray">
                                    <a href="#" class="leading-[1.18] tracking-[-0.48px] h-[51px] w-full border border-light-gray rounded-[6px] py-4 flex justify-center items-center text-[16px] font-medium text-[#1e1d1d] hover:bg-gray-50 transition-colors">
                                        View all listings
                                    </a>
                                </div>
                            </div>
